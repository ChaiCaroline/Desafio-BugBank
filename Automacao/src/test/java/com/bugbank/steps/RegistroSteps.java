...
public class RegistroSteps {
    ...
    public void devera_ser_exibida_na_tela_inicial_do_bugbank_com_um_saldo_inicial_zerado(String string) {
    ...
    public void o_usuario_tiver_preenchindo_o_campo_de_email_com_um_email_invalido(String string) {
    ...
    public void o_usuario_preencher_o_campo_de_email_com_um_email_valido(String string) {
    ...
    public void o_usuario_digitou_um_email_valido(String string) {
